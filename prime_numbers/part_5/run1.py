...
for c in content:
    ...
    circle = plt.Circle((x, 0), r, linewidth=color_map[r]["thick"], fill=False, edgecolor=color_map[r]["color"])
    ax.add_artist(circle)
    ax.annotate(str(x), xy=(x, r + 0.2), fontsize=45, ha="center", weight="bold")
    ax.annotate("(" + str(x - r) + "," + str(x + r) + ")", xy=(x, r - 0.6), fontsize=45, ha="center", weight="bold")
